...
define(["require", "exports", "dojo/_base/declare", "dojo/_base/array", "dojo/query", "dojo/dom-style", "dojo/on", "dojo/fx", "dojo/_base/fx", "dojo/_base/lang", "dojo/dom-attr", "dojo/dom-class", "dijit/_WidgetBase", "dijit/_Container", "dojo/dnd/Moveable", "dijit/_TemplatedMixin", "dojo/text!./templates/MoveableWidgetFrame.html"], function (require, exports, declare, array, query, domStyle, on, coreFx, fx, lang, domAttr, domClass, _WidgetBase, _Container, Moveable, _TemplatedMixin, template) {
    "use strict";
    //import QueryEngine = dojo.store.api.QueryEngine;
    var MoveableWidgetFrame = declare("MoveableWidgetFrame", [_WidgetBase, _TemplatedMixin, _Container], {
        //包含的控件
        widget: null,
        icon: "",
        title: "",
        ...
        startup: function () {
            ...
            // measure the box as laid out in the default position
        ...
        setWidget: function (/*webgis2book.widgets._Widget*/ widget, /*boolean*/ childAlreadyAdded) {
            ...
            try {
                ...
                var minBtnTd = minBtn.parentNode;
    ...
    return MoveableWidgetFrame;
});
//# sourceMappingURL=MoveableWidgetFrame.js.map