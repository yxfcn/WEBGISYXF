...
define(["require", "exports", "dojo/parser", "esri/config", "esri/map", "esri/layers/FeatureLayer", "esri/toolbars/edit", "esri/tasks/query", "dojo/_base/event", "esri/layers/ArcGISDynamicMapServiceLayer", "esri/SpatialReference", "esri/geometry/Point"], function (require, exports, parser, esriConfig, Map, FeatureLayer, Edit, Query, event, ArcGISDynamicMapServiceLayer, SpatialReference, EsriPoint) {
    "use strict";
    ...
    var centerPoint = new EsriPoint(13496486.08431000, 3358928.83260318, SR);
    map = new Map("map", {
        basemap: "topo",
        center: centerPoint,
        zoom: 11
...
//# sourceMappingURL=MoveEdit.js.map