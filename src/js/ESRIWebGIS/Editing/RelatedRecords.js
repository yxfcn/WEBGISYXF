...
define(["require", "exports", "esri/config", "dojo/parser", "esri/map", "esri/layers/FeatureLayer", "esri/symbols/SimpleMarkerSymbol", "esri/Color", "esri/request", "esri/graphic", "esri/tasks/RelationshipQuery", "dojo/dom", "esri/dijit/editing/TemplatePicker"], function (require, exports, esriConfig, parser, Map, FeatureLayer, SimpleMarkerSymbol, Color, esriRequest, Graphic, RelationshipQuery, dom, TemplatePicker) {
    "use strict";
    ...
    voteOnIncident = function (objectId) {
        ...
        incidentVoteTable.applyEdits([voteRecord], null, null, function (addResults) {
...
//# sourceMappingURL=RelatedRecords.js.map